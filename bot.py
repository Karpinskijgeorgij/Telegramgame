...
btn2 = KeyboardButton('🎲 Кости')
btn3 = KeyboardButton('🎰 Рулетка')
btn4 = KeyboardButton('🏀 Баскет')
btn5 = KeyboardButton('⚽')
btn6 = KeyboardButton('🎯')
btn7 = KeyboardButton('👑 Топ игроков')
btn8 = KeyboardButton('🎖 Купить очки')
btn9 = KeyboardButton('⚡ Топ бесед')
